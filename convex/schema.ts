...
created_at: v.number(),
  ...
  scenes: defineTable({
    ...
    foreground_url: v.optional(v.union(v.string(), v.null())),
    background_asset_id: v.optional(v.union(v.string(), v.null())),
    foreground_asset_id: v.optional(v.union(v.string(), v.null())),
  ...
  characters_stats: defineTable({
    ...
    // deprecated: 削除予定。既存データ互換のため optional で残す
  ...
  characters_base: defineTable({
    ...
    images: v.array(
      v.object({
        ...
        asset_id: v.optional(v.union(v.string(), v.null())),
        label: v.string(),
      })
    ),
    memo: v.string(),
  ...
  bgms: defineTable({
    ...
    bgm_asset_id: v.optional(v.union(v.string(), v.null())),
    bgm_volume: v.number(),
    bgm_loop: v.boolean(),
    scene_ids: v.array(v.string()),

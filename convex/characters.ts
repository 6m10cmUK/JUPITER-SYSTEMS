...
export const create = mutation({
  args: {
    ...
    owner_id: v.string(),
    name: v.string(),
    images: v.array(v.object({ url: v.optional(v.string()), asset_id: v.optional(v.union(v.string(), v.null())), label: v.string() })),
...
export const updateBase = mutation({
  args: {
    id: v.string(),
    images: v.optional(v.array(v.object({ url: v.optional(v.string()), asset_id: v.optional(v.union(v.string(), v.null())), label: v.string() }))),
